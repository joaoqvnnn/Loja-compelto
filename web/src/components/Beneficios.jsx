...
/* =========================================================
   ...
   plataforma, calculados pelo backend automaticamente)
   ========================================================= */
const ESTATISTICAS = [
...
/* =========================================================
   ...
   ========================================================= */
const BENEFICIOS = [
  { Icone: Zap,         titulo: 'Entrega automática', descricao: 'O produto chega na hora, direto no seu e-mail ou painel.',         cor: '#f59e0b' },
  { Icone: ShieldCheck, titulo: 'Compra protegida',   descricao: 'Sistema antifraude e reembolso garantido se algo der errado.',        cor: '#16a34a' },
  { Icone: Lock,        titulo: 'Pagamento seguro',   descricao: 'PIX processado com criptografia e confirmação em segundos.',          cor: '#2563eb' },
  { Icone: Headphones,  titulo: 'Suporte 24/7',       descricao: 'Atendimento humano por chat sempre que você precisar.',              cor: '#7c3aed' },
]
    ...
    <section className="container-app py-12">
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold mb-2">A plataforma em números</h2>
          <p className="text-sm texto-suave">Milhares de pessoas já confiam na TrustMarket</p>
        </div>
          ...
          {ESTATISTICAS.map((e, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-xs sm:text-sm texto-suave mt-1">{e.label}</span>
              </motion.div>
            )
          })}
        </div>
      ...
      {/* Bloco 2: benefícios */}
      <div className="text-center mb-8">
        <h2 className="text-2xl sm:text-3xl font-bold mb-2">Por que escolher a TrustMarket?</h2>
        <p className="text-sm texto-suave">Tudo que você precisa em um só lugar</p>
      </div>
        ...
        {BENEFICIOS.map((b, i) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="font-semibold mb-1.5">{b.titulo}</h3>
              <p className="text-sm texto-suave leading-relaxed">{b.descricao}</p>
            </motion.div>
          )
        })}
      </div>
