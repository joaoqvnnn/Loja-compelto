...
import {
  Heart, ShoppingCart, ChevronRight, Star, Package, Flame,
  Gamepad2, Film, Music, BookOpen, Camera, Laptop
} from 'lucide-react'

/* =========================================================
   PRODUTOS — depois virão do banco (admin cadastra, escolhe
   o ícone/imagem, preços, desconto, etc)
   ========================================================= */
const PRODUTOS = [
  {
    id: 1,
    ...
    avaliacao: 4.9, vendidos: 1243, estoque: 9989,
  },
  {
    id: 2,
    Icone: Film,
    ...
    avaliacao: 4.8, vendidos: 872, estoque: 342,
  },
  {
    id: 3,
    Icone: Music,
    ...
    avaliacao: 4.9, vendidos: 2104, estoque: 128,
  },
  {
    id: 4,
    Icone: BookOpen,
    ...
    avaliacao: 4.7, vendidos: 431, estoque: 9999,
  },
  {
    id: 5,
    Icone: Camera,
    ...
    avaliacao: 4.6, vendidos: 654, estoque: 500,
  },
  {
    id: 6,
    Icone: Laptop,
    ...
    avaliacao: 4.8, vendidos: 1089, estoque: 87,
  },
]
...
function CardProduto({ p, i }) {
  ...
  return (
    ...
    >
      ...
      >
        <Icone size={64} color="white" strokeWidth={1.5} />
